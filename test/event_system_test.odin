...
state_machine_caller :: proc( state_machine_pointer: event_system.State_Machine_Pointer, p_queue_event: ^event_system.Queue_Event )
{
    switch state_machine_pointer.state_machine_type {
        case finite_state_machine.Finite_State_Machine( example.Some_State, example.Some_Input ):
            finite_state_machine.state_transition( example.Some_State, example.Some_Input, state_machine_pointer, p_queue_event )
        case:
